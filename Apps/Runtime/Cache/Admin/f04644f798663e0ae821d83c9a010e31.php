			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							<a href="/equipment/admin.php/News/Index" class="dropdown-toggle">
 ...
 <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                <h1>
                   <a href="/equipment/admin.php/News/add">发布新闻</a>
                </h1>
                                        ...
                                        <?php if(is_array($list)): foreach($list as $key=>$new): ?><tr>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a href="/equipment/admin.php/News/edit/id/<?php echo ($new['id']); ?>" class="btn btn-xs btn-info">
                                                        <i class="icon-edit bigger-120">修改</i>
                                                    </a>

                                                    <a href="/equipment/admin.php/News/del/id/<?php echo ($new['id']); ?>" class="btn btn-xs btn-danger">
