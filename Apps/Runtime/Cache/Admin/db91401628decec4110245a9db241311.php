        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="/equipment/admin.php/Market/update" class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($_GET['id']); ?>"/>
						<div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 商城名 </label>

                            <div class="col-sm-9">
                                <input name="market_name" type="text" id="form-field-1" placeholder="请输入商城名" class="col-xs-10 col-sm-3" value="<?php echo ($market['market_name']); ?>"/>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 商城简介 </label>

                            <div class="col-sm-9">
                                <textarea class="col-xs-10 col-sm-3" name="market_descr" ><?php echo ($market['market_descr']); ?></textarea>
                                <span class="help-inline col-xs-12 col-sm-7">
                                    <span class="middle"></span>
                                </span>
                            </div>
						...
						<div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 联系电话 </label>
								<div class="col-sm-9">
									<input type="text" name="market_phone" class="col-xs-10 col-sm-3" id="form-input-readonly" value="<?php echo ($market['market_phone']); ?>"/>
									<span class="help-inline col-xs-12 col-sm-7">
										<label class="middle">
											<span class="lbl"></span>
										</label>
...
<![endif]-->
    ...
    <!--<script src="/equipment/Public/admin/assets/js/dropzone.min.js"></script>
    <script type="text/javascript">
			jQuery(function($){
		...
		<script src="/equipment/Public/admin/assets/js/jquery.hotkeys.min.js"></script>
		<script src="/equipment/Public/admin/assets/js/bootstrap-wysiwyg.min.js"></script>
        <script type="text/javascript">
			jQuery(function($){
