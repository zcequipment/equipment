                                ...
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php if(is_array($links)): foreach($links as $key=>$link): ?><tr>
                                            ...
                                            <td><img src="/equipment/Public/Uploads/links/s_<?php echo ($link['linklogo']); ?>"/></td>
                                           ...
                                           <!--  <td class="hidden-480">
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a href="/equipment/admin.php/Link/edit/id/<?php echo ($link['id']); ?>" class="btn btn-xs btn-info">
                                                        <i class="icon-edit bigger-120"></i>
                                                    </a>
                                                    <a href="/equipment/admin.php/Link/del/id/<?php echo ($link['id']); ?>" class="btn btn-xs btn-danger">
