			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							<a href="/equipment/admin.php/Notices/Index" class="dropdown-toggle">
 ...
 <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                <h1>
                    <a href="/equipment/admin.php/Notices/add">发布消息</a>
                </h1>
                                        ...
                                        <?php if(is_array($list)): foreach($list as $key=>$notice): ?><tr>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    <a href="/equipment/admin.php/Notices/edit/id/<?php echo ($notice['id']); ?>" class="btn btn-xs btn-info">
                                                        <i class="icon-edit bigger-120">修改</i>
                                                    </a>

                                                    <a href="/equipment/admin.php/Notices/del/id/<?php echo ($notice['id']); ?>" class="btn btn-xs btn-danger">
